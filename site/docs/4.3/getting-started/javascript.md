...
Our v5 isn't designed to work with IE 11, but you can add the following polyfills to make it work:

{% capture callout %}
Our v5 will continue to add new features, so be aware that it's possible that this breaks in the the future.
{% endcapture %}
{% include callout.html content=callout type="warning" %}
